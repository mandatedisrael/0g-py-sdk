...
SERVING_CONTRACT_ABI = [
    ...
    {"inputs": [{"internalType": "address", "name": "provider", "type": "address"}], "name": "acknowledgeTEESignerByOwner", "outputs": [], "stateMutability": "nonpayable", "type": "function"},
